    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button variant="ghost" size="icon" onClick={() => setIsGridView(false)} className={!isGridView ? "bg-gray-100" : ""}>
            <LayoutList className="h-4 w-4" />
          </Button>
          <Button variant="ghost" size="icon" onClick={() => setIsGridView(true)} className={isGridView ? "bg-gray-100" : ""}>
              ...
              filteredPosts.map((postItem, index) => (
                ...
                >
                  <div className={`flex-1 p-4 ${isGridView ? "" : "w-2/3"}`}>
                    <div className="flex items-center space-x-2 mb-2">
                      <Avatar className="h-6 w-6">
                        ...
                        />
                        <AvatarFallback>{postItem?.author ? postItem.author[0] : "A"}</AvatarFallback>
                      </Avatar>
                  ...
                  {postItem.banner_link && (
                    <div className={`${isGridView ? "w-full h-48" : "w-1/3 h-48"} relative flex-shrink-0`}>
                      <img
                        src={
